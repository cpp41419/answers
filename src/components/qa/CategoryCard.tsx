...
export function CategoryCard({ category }: CategoryCardProps) {
  return (
    <Link href={`/questions/${category.slug}`} className="group block h-full">
      <Card className="h-full flex flex-col bg-[hsl(var(--deep-navy))] text-primary-foreground hover:ring-2 hover:ring-accent transition-all duration-300 rounded-xl overflow-hidden shadow-lg">
        ...
        <CardFooter className="mt-auto pt-3 border-t border-primary-foreground/20">
